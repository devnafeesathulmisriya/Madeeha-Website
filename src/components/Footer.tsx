...
const footerLinks = {
  ...
  Support: [
    { label: "Help Center", href: "mailto:support@madeeha.com" },
    { label: "Student Portal", href: "https://madeeha-thesweetnessofiman.web.app/login" },
    { label: "Faculty Login", href: "https://madeeha-thesweetnessofiman.web.app/login" },
